...
1. Clone the repository:
   ...
   ```bash
   git clone https://github.com/your-username/decentralized-image-upload.git](https://github.com/arifakhtar51/Exam-3.0.git
   ```
...
2. I have already configured For Divyanshu ,
